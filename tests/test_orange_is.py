...
def wait_for_size_stable(locator: Locator, stable_duration: float = 0.5, poll_interval: float = 0.25,
                         timeout: float = 3.0):
...
class TestOrange:
	...
	def test_sidepanel_change_size_by_class(self, page: Page):
	...
	def test_sidepanel_change_size_by_css(self, page: Page):
	...
	def test_sidepanel_change_size_by_evaluate(self, page: Page):
		sidepanel = page.get_by_role("navigation", name="Sidepanel")
